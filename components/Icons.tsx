...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c.401-.044.812-.092 1.224-.15c.412-.058.832-.125 1.255-.203a11.97 11.97 0 0 1 5.642 0c.423.078.843.145 1.255.203c.412.058.823.106 1.224.15a7.5 7.5 0 0 1-7.5 0Zm-2.25-4.484c.818.324 1.724.484 2.65.484c.926 0 1.832-.16 2.65-.484m-5.3 0c-.818.324-1.724.484-2.65.484A6.375 6.375 0 0 1 3 12.161V12a9 9 0 0 1 18 0v.161a6.375 6.375 0 0 1-3.35 4.484Z" />
    </svg>
);

export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118A2.25 2.25 0 0 0 1 18.336a2.25 2.25 0 0 0 2.25 2.25h1.5A2.25 2.25 0 0 0 7.5 18.336a2.25 2.25 0 0 1 2.475-2.118 3 3 0 0 0 5.78-1.128Zm-5.78 1.128L11.47 12l-2.24 2.24m5.78-1.128a3 3 0 0 1 5.78-1.128 2.25 2.25 0 0 0 2.475-2.118 2.25 2.25 0 0 1 2.25-2.25 2.25 2.25 0 0 1 2.25 2.25h-1.5a2.25 2.25 0 0 1-2.25 2.25 2.25 2.25 0 0 0-2.475 2.118 3 3 0 0 1-5.78 1.128Zm-5.78-1.128L8.23 8.23m5.78 1.128L11.47 12l2.24-2.24M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
);
